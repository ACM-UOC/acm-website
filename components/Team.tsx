...
const team: TeamMember[] = [
  ...
  { name: "Vasiliki Tsiouvra", roleKey: "vice_chair", linkedin: "https://linkedin.com" },
          ...
          {team.map((member) => (
            <div key={member.name} className="group flex flex-col items-center w-48">
              ...
              <div className="space-y-2">
                ...
                {member.linkedin && (
                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" aria-label={`${member.name} on LinkedIn`} className="inline-block mt-2 text-slate-300 hover:text-blue-600 transition-colors">
